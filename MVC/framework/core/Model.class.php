...
//      $this->getFields();
    ...
    private function getFields(){
        ...
        foreach ($result as $v){
            ...
            if($v['key'] == 'PRI'){
                //if there is PrimaryKey, save it in $pk
                $pk = $v['Field'];
    ...
    public function update($list){
        ...
        if($this->db->query($sql)){
            //If succees, return the count of affected rows
     ...
     * Delete records
     * @access public
     * @param $pk mixed could be an int ir an array
